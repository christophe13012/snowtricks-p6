 ...
 */
final class Version20201218093918 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tricks ADD category_id INT DEFAULT NULL, DROP category');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tricks ADD category INT NOT NULL, DROP category_id');
    }
}
